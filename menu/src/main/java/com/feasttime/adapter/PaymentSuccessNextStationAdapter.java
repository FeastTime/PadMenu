 ...
 */
public class PaymentSuccessNextStationAdapter extends RecyclerView.Adapter<PaymentSuccessNextStationAdapter.MyViewHolder> {
    ...
    public PaymentSuccessNextStationAdapter(List<RecommendOrderListItemInfo> datas, Activity activity) {
        context = activity;
        this.datas = datas;
    }
