package com.feasttime.dishmap.config;
...
public class GlobalConfig {
    public static int APP_STATUS = 2;  // 0:release , 1: test , 2: development ,3:本地调试
    ...
    public static final String RELEASE_IM_RONGYUN_APPSECRET = "ttdtrxl5FT4W"; //融云appsecret
}
