...
package com.feasttime.dishmap.third.onekeyshare.themes.classic;
...
import com.feasttime.dishmap.third.onekeyshare.CustomerLogo;
import com.feasttime.dishmap.third.onekeyshare.OnekeySharePage;
import com.feasttime.dishmap.third.onekeyshare.OnekeyShareThemeImpl;
...
public abstract class PlatformPage extends OnekeySharePage {
	...
	protected ArrayList<Object> collectCells() {
		...
		hides.put("Facebook","Facebook");
		hides.put("Twitter","Twitter");
		hides.put("Renren","Renren");
		hides.put("KaiXin","KaiXin");
		hides.put("Email","Email");
		hides.put("ShortMessage","ShortMessage");
		hides.put("Douban","Douban");
		hides.put("YouDao","YouDao");
		hides.put("Evernote","Evernote");
		hides.put("LinkedIn","LinkedIn");
		hides.put("GooglePlus","GooglePlus");
		hides.put("FourSquare","FourSquare");
		hides.put("Pinterest","Pinterest");
		hides.put("Flickr","Flickr");
		hides.put("Tumblr","Tumblr");
		hides.put("Dropbox","Dropbox");
		hides.put("VKontakte","VKontakte");
		hides.put("Dropbox","Dropbox");
		hides.put("Instagram","Instagram");
		hides.put("Yixin","Yixin");
		hides.put("YixinMoments","YixinMoments");
		hides.put("Mingdao","Mingdao");
		hides.put("Line","Line");
		hides.put("KakaoTalk","KakaoTalk");
		hides.put("KakaoStory","KakaoStory");
		hides.put("WhatsApp","WhatsApp");
		hides.put("Pocket","Pocket");
		hides.put("Instapaper","Instapaper");
		hides.put("FacebookMessenger","FacebookMessenger");
		hides.put("Telegram","Telegram");
		hides.put("Alipay","Alipay");
		hides.put("AlipayMoments","AlipayMoments");
		hides.put("Dingding","Dingding");
		hides.put("Youtube","Youtube");
		hides.put("Meipai","Meipai");


		for (Platform p : platforms) {
			if (!hides.containsKey(p.getName())) {
				cells.add(p);
				Log.d("resultName",p.getName());
			}
		}
		...
		beforeFinish = new Runnable() {
			public void run() {
				...
				if (isSilent || isCustomPlatform || isUseClientToShare) {
					...
					Platform.ShareParams sp = formateShareData(platform);
					if (sp != null) {
						// 编辑分享内容的统计
