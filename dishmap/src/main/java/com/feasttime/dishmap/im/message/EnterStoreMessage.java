...
public class EnterStoreMessage extends MessageContent {
     ...
     */
    public EnterStoreMessage(byte[] data) {
     ...
     */
    private EnterStoreMessage(Parcel in) {
     ...
     */
    public static final Creator<EnterStoreMessage> CREATOR = new Creator<EnterStoreMessage>() {
        @Override
        public EnterStoreMessage createFromParcel(Parcel source) {
            return new EnterStoreMessage(source);
        }

        @Override
        public EnterStoreMessage[] newArray(int size) {
            return new EnterStoreMessage[size];
        }
    };
    ...
    public static EnterStoreMessage obtain(long time, String content) {
        EnterStoreMessage customizeMessage = new EnterStoreMessage();
